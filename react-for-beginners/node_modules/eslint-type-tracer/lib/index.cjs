...
const __eslint_community_eslint_utils = __toESM(require("@eslint-community/eslint-utils"));
...
function getStaticKeyValue(node, initialScope) {
	const value = (0, __eslint_community_eslint_utils.getStaticValue)(node, initialScope);
...
function buildExpressionTypeProviderImpl(sourceCode) {
	...
	*/
	function findVariableFromIdentifier(node) {
		return (0, __eslint_community_eslint_utils.findVariable)(sourceCode.scopeManager.globalScope, node);
	}
	/**
...
exports.buildTypeTracer = buildTypeTracer;